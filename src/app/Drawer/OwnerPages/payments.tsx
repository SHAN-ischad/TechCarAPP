    ...
    return (
        <ScrollView className='flex-1 '>
            ...
            <View className='w-[90%] ml-[5%]  mt-[30px] flex-row items-center pb-[20px] border-b-[2px] border-black'>
                <Text className='text-[19pt] font-tintNeon font-bold'>Pagamentos</Text>
            ...
            <View className='w-full mt-[3%] items-center '>
                ...
                <View className='w-[80%] bg-blue-500 flex-row items-center  h-[200px] rounded-[10px]'>
                    ...
                    <View className='w-[48%] ml-[2%]  flex-col'>
                        ...
                        <Text className='text-[12pt] font-tintNeon max-md:text-[10pt] max-sm:text-[9pt] text-white font-bold mt-[10px]'>
                            Total de Serviços Mensais
                            <Text className='text-[12pt] font-tintNeon max-md:text-[10pt] max-sm:text-[9pt] text-white font-bold'> 50</Text>
                        </Text>
                    </View>
                    ...
                    <View className='w-[48%] h-[97%] mb-[3%] mr-[2%] justify-end items-end'>
                        <Pressable
                            ...
                            className='w-fit'>
                            <Text className='text-[10pt] font-tintNeon max-md:text-[9pt] max-sm:text-[8pt] text-white font-bold'>Histórico dos últimos meses</Text>
                        </Pressable>
                    </View>
                </View>
            </View>
            ...
            <View className='w-full items-center mt-[5%] mb-[30px]'>
                ...
                <View className='flex-row max-[900px]:flex-col max-[900px]:w-full gap-[20px] '>
                    ...
                    <Pressable
                        ...
                        <Text className='font-bold font-tintNeon text-[15pt]'>Serviços Finalizados</Text>
                    ...
                    <Pressable
                        ...
                        <Text className='font-bold font-tintNeon text-[15pt]'>Ir para Financeiro</Text>
                        <Ionicons name='caret-forward' size={20} className='top-[4px]' />
                    </Pressable>
                </View>
            </View>
