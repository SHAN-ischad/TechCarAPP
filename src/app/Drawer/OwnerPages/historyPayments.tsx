                ...
                <View className='w-full  items-center '>
                    ...
                    <View className='w-[80%] bg-blue-500  flex-row items-center  h-[200px] rounded-[10px]'>
                        ...
                        <View className='w-[48%] ml-[2%] gap-[5px] flex-col'>
                            <Text className='text-white font-bold text-[16pt] max-md:text-[16pt] max-sm:text-[11pt]'>Total do Mês</Text>
                            <Text className='text-white font-bold text-[20pt] max-md:text-[16pt] max-sm:text-[13pt]'>R$ 10.000</Text>
                            {/* Amount Services in month */}
                            <Text className='text-[12pt] max-md:text-[10pt] max-sm:text-[12pt] text-white font-bold mt-[10px]'>
                                Total de Serviços no Mês
                                <Text className='text-[12pt] max-md:text-[10pt] max-sm:text-[12pt] text-white font-bold'> 50</Text>
                            </Text>
                            <Text className='text-[12pt] max-md:text-[10pt] max-sm:text-[12pt] text-white font-bold'>Mês Correspondente: {getMounth()}</Text>
                        </View>
                    </View>
