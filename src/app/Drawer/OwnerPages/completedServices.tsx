    ...
    return (
        <ScrollView className='flex-1'>
            ...
            <View className='w-[97%] flex-row items-center mt-[20px] ml-[2%] border-b-[2px] pb-[20px]'>
                <Text className='text-[19pt] font-tintNeon'>Serviços Completos</Text>
            ...
            <View className='w-[97%] ml-[2%] mt-[2%]'>
                ...
                <View className='flex-row max-[1000px]:hidden gap-[50px] items-center border-b pb-2'>
                    <Text className='text-[14pt] font-tintNeon font-bold w-[120px] min-w-[120px]'>Nome</Text>
                    <Text className='text-[14pt] font-tintNeon font-bold w-[100px] min-w-[100px]'>Carro</Text>
                    <Text className='text-[14pt] font-tintNeon font-bold w-[140px] min-w-[140px]'>CPF</Text>
                    <Text className='text-[14pt] font-tintNeon font-bold w-[150px] min-w-[150px]'>Data de Abertura</Text>
                    <Text className='text-[14pt] font-tintNeon font-bold w-[170px] min-w-[170px]'>Data de Fechamento</Text>
                    <Text className='text-[14pt] font-tintNeon font-bold w-[120px] min-w-[120px]'>Total Pago</Text>
                </View>
                {/* Dados */}
                {services.map(service => (
                    ...
                    >
                        ...
                        <View className="flex-row max-[1000px]:flex-col items-center max-[1000px]:items-start w-[120px] min-w-[120px]">
                            <Text className='text-[11pt] font-tintNeon min-[1001px]:hidden font-bold'>Nome</Text>
                        ...
                        <View className="flex-row max-[1000px]:flex-col items-center max-[1000px]:items-start w-[100px] min-w-[100px]">
                            <Text className='text-[11pt] font-tintNeon min-[1001px]:hidden font-bold'>Carro</Text>
                        ...
                        <View className="flex-row max-[1000px]:flex-col items-center max-[1000px]:items-start w-[140px] min-w-[140px]">
                            <Text className='text-[11pt] font-tintNeon min-[1001px]:hidden font-bold'>CPF</Text>
                            <Text>{service.cpf}</Text>
                        </View>
                        {/* Data de Abertura */}
                        <View className="flex-row max-[1000px]:flex-col items-center max-[1000px]:items-start w-[150px] min-w-[150px]">
                            <Text className='text-[11pt] font-tintNeon min-[1001px]:hidden font-bold'>Data de Abertura</Text>
                        ...
                        <View className="flex-row max-[1000px]:flex-col items-center max-[1000px]:items-start w-[170px] min-w-[170px]">
                            <Text className='text-[11pt] font-tintNeon min-[1001px]:hidden font-bold'>Data de Fechamento</Text>
                            <Text>{service.fechamento}</Text>
                        </View>
                        {/* Total Pago */}
                        <View className="flex-row max-[1000px]:flex-col items-center max-[1000px]:items-start w-[120px] min-w-[120px]">
                            <Text className='text-[11pt] font-tintNeon min-[1001px]:hidden font-bold'>Total Pago</Text>
