    ...
    return (
        <ScrollView className='flex-1 max-[900px]:py-[20px] '>
            ...
            <View className='w-full items-start my-[2%]' >
                <Text className='text-[15pt] font-sourceSans3'>Conta Escolhida: <Text className='bg-blue-500/80 text-white rounded-[10px] p-[7px]'>Proprietário</Text></Text>
            </View>
            {/* FormCarArea */}
            <View className='min-h-[200px]  py-[10px] w-full  items-center max-h-fit'>
                {/* Content */}
                <View className='w-[400px] min-w-fit min-h-[400px] max-h-fit pb-[10px] rounded-[10px]  gap-[20px] items-center p-x-[300]  '>
                    <Text className='text-[20pt] font-sourceSans3 mt-[10px]'>Cadastro de Propriedade</Text>

                    <TextInput
                        value={nomeOficina}
                        onChangeText={setNomeOficina}
                        className='min-w-[100%]  pl-[10px] min-h-[45px]  rounded-[20px] placeholder:text-[12pt] font-sourceSans3 border-[1px] duration-[300ms] focus:rounded-[5px]  ' placeholder='Nome da oficina' />

                    <TextInput
                        value={cnpj}
                        onChangeText={setCnpj}
                        className='min-w-[100%] pl-[10px] min-h-[45px]  rounded-[20px] placeholder:text-[12pt] font-sourceSans3 border-[1px] duration-[300ms] focus:rounded-[5px]  ' placeholder='CNPJ' />

                    <TextInput
                        value={endereco}
                        onChangeText={setEndereco}
                        className='min-w-[100%] pl-[10px] min-h-[45px]  rounded-[20px] placeholder:text-[12pt] font-sourceSans3 border-[1px] duration-[300ms] focus:rounded-[5px]  ' placeholder='Endereço' />

                    <TextInput
                        value={cidade}
                        onChangeText={setCidade}
                        className='min-w-[100%] pl-[10px] min-h-[45px]  rounded-[20px] placeholder:text-[12pt] font-sourceSans3 border-[1px] duration-[300ms] focus:rounded-[5px]  ' placeholder='Cidade' />

                    <TextInput
                        value={horarioFuncionamento}
                        onChangeText={setHorarioFuncionamento}
                        className='min-w-[100%] pl-[10px] min-h-[45px]  rounded-[20px] placeholder:text-[12pt] font-sourceSans3 border-[1px] duration-[300ms] focus:rounded-[5px]  ' placeholder='Horário de funcionamento' />
                    ...
                    <TextInput
                        ...
                        className='min-w-[100%] placeholder:justify-center  pl-[10px] min-h-[45px]  rounded-[20px] placeholder:text-[12pt] font-sourceSans3 border-[1px] duration-[300ms] focus:rounded-[5px] placeholder:top-[20px] placeholder:relative  ' placeholder='Descrição' />
                </View>
            </View>
            {/* Bottom */}
