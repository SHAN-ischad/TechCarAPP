        ...
        <ScrollView className='flex-1 max-[900px]:py-[20px] bg-slate-500/20'>
            ...
            <View className='min-h-[200px] w-full  items-center max-h-fit'>
                ...
                <View className='w-[300px] min-h-[400px] max-h-fit pb-[10px] rounded-[10px] gap-[20px] items-center bg-slate-100  '>
                    ...
                    <TextInput className='min-w-[220px] pl-[10px] min-h-[35px]  rounded-[10px] placeholder:text-[12pt] font-sourceSans3 border-[1px] duration-[300ms] focus:rounded-[5px]  ' placeholder='Nome da oficina' />

                    <TextInput className='min-w-[220px] pl-[10px] min-h-[35px]  rounded-[10px] placeholder:text-[12pt] font-sourceSans3 border-[1px] duration-[300ms] focus:rounded-[5px]  ' placeholder='CNPJ' />

                    <TextInput className='min-w-[220px] pl-[10px] min-h-[35px]  rounded-[10px] placeholder:text-[12pt] font-sourceSans3 border-[1px] duration-[300ms] focus:rounded-[5px]  ' placeholder='Endereço' />
                    ...
                    <TextInput className='min-w-[220px] pl-[10px] min-h-[35px]  rounded-[10px] placeholder:text-[12pt] font-sourceSans3 border-[1px] duration-[300ms] focus:rounded-[5px]  ' placeholder='Horário de funcionamento' />
