...
export default function PostCadaster() {
    ...
    return (
        <ScrollView className='flex-1 justify-center ' >
            {/* FormArea */}
            <View className='w-fit h-fit mx-auto p-10 shadow-md mt-[10px] rounded-[10px] mb-[5%]'>
                    ...
                    <View className='w-full  items-center justify-center gap-[20px] '>
                        ...
                        <View className='w-fit items-center'>
                            ...
                            <Picker
                                ...
                                className='w-fit min-h-[30px] font-sourceSans3 p-[12px] rounded-[10px] border-[2px] border-black  flex-row gap-[10px]'>
                        ...
                        <View className='w-fit  grid grid-cols-2 max-[900px]:grid-cols-1  gap-[10px]'>

                            <TextInput className='min-w-[220px] w-[60%] pl-[10px] min-h-[45px]  rounded-[10px] placeholder:text-[12pt] font-sourceSans3 border-[1px] duration-[300ms] focus:rounded-[5px]  ' placeholder='CPF' />
                            <TextInput className='min-w-[220px] w-[60%] pl-[10px] min-h-[45px]  rounded-[10px] placeholder:text-[12pt] font-sourceSans3 border-[1px] duration-[300ms] focus:rounded-[5px]  ' placeholder='Data de nascimento' />
                            <TextInput className='min-w-[220px] w-[60%] pl-[10px] min-h-[45px]  rounded-[10px] placeholder:text-[12pt] font-sourceSans3 border-[1px] duration-[300ms] focus:rounded-[5px]  ' placeholder='Idade' />
                            <TextInput className='min-w-[220px] w-[60%] pl-[10px] min-h-[45px]  rounded-[10px] placeholder:text-[12pt] font-sourceSans3 border-[1px] duration-[300ms] focus:rounded-[5px]  ' placeholder='Cidade' />
                            <TextInput className='min-w-[220px] w-[60%] pl-[10px] min-h-[45px]  rounded-[10px] placeholder:text-[12pt] font-sourceSans3 border-[1px] duration-[300ms] focus:rounded-[5px]  ' placeholder='Estado' />
                            <TextInput className='min-w-[220px] w-[60%] pl-[10px] min-h-[45px]  rounded-[10px] placeholder:text-[12pt] font-sourceSans3 border-[1px] duration-[300ms] focus:rounded-[5px]  ' placeholder='Telefone' />
                        </View>
