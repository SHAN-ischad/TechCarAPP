        ...
        <View className='w-full max-sm:items-center mt-[2.5%] max-sm:mt-[0%] mb-[0px]  h-fit   ' >
            ...
            <View className='w-full max-sm:justify-center gap-[20px]  '>
                ...
                <View
                    ...
                    <Image
                        source={{ uri: cadastro?.clientImage || 'https://github.com/SHAN-ischad.png' }}
                    ...
                    <View className='h-full flex-col justify-center'>
                        <Text className='font-semibold text-[13pt] max-sm:text-[10pt]'>
                            Bem vindo de volta{'\n'}<Text className='text-[15pt]'>{cadastro?.nome}</Text>
                        </Text>
                    </View>
                ...
                <View className='w-full min-[600px]:ml-[5px] '>
                    ...
                    <View className='w-[700px] flex-row items-center justify-center  max-sm:w-full  '>
                        ...
                        <GlobalInputs setAtribute={() => { }} backgroundColor='' borderRadius='10px' padding='10px' placeholder='Pesquisar por...' value='' marginBottom='0px' marginLeft='0' marginRight='0' marginTop='0px' secureTextEntry={false} />
                    ...
                    <View className='w-full  max-sm:flex-wrap max-sm:justify-start flex-row  justify-start  gap-[20px]'>
                        ...
                        <GlobalButton
                            action={() => {
                                const idVeiculo = cadastro?.carro?._id  // ajuste conforme seu backend
                                if (idVeiculo) {
                                    router.push({ pathname: '/Drawer/vehicle', params: { id: idVeiculo } });
                                }
                            }}
                            fontBold='semibold' backgroundColor='bg-gray-300' fontSize='11pt' marginBottom='0'
