            ...
            <Pressable className='w-full min-[800px]:w-[600px] p-[8px] rounded-[8px]  flex-row items-center gap-[50px] bg-slate-300/20 border-[1px] hover:bg-gray-400 duration-[300ms] active:scale-[0.95] '>
                ...
                <View className='flex-[60%] h-full flex-col '>
                    ...
                    <View className='w-full flex-row items-center gap-[20px]'>
                        ...
                        <Text className='text-[10pt] font-tintNeon font-semibold'>
                    ...
                    <View className='w-full'>
                        <Text className='text-[10pt] font-tintNeon font-semibold text-black'>
                ...
                <View className='flex-[40%] h-full flex-col gap-[10px] ' >
                    <Text className='text-[12.7pt] font-tintNeon'>Serviço Prestado</Text>
                    <Text className='text-[11pt] font-tintNeon text-black'>{serviceProvided}</Text>
                    <Text className='text-[11pt] font-tintNeon text-green-400'><Text className='text-black font-tintNeon'>Valor: </Text>R$ {value}</Text>
                </View>
            </Pressable>
        </>
    );
